...
A machine learning project that builds and evaluates a logistic regression model to predict UFC fight winners using scraped historical fighter and fight data.
